...
class CocoDetection(data.Dataset):
    ...
    def __init__(self, root, dataset="train", transforms=None):
        ...
        self.coco_incides = os.path.join(root, "coco91_indices.json")
        ...
        if os.path.exists(self.coco_incides):
            ...
            for k in range(1, max_index + 1):
                if k in data_classes:
                    ...
                    coco_classes[k] = "N/A"
            if dataset == "train":
                json.dump(coco_classes, open(self.coco_incides, "w"), indent=4)
...
if __name__ == "__main__":
    #! the path to COCO2017 dataset
    dataset = CocoDetection(r"D:\\pythonProject\\AI_from_bili\\data\\COCO2017")
