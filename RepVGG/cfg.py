import os, torch
#! 在这更换要使用的网络
from model import create_RepVGG_A0 as Net
...
cfg.update({"data_root": os.path.join(cfg['dir_root'], "..", "data", cfg["data_name"]),
            ...
            "net": Net(num_classes=cfg['num_classes'], deploy=False).to(cfg["device"]),
            "save_path_deploy": os.path.join(cfg['dir_root'], "model_trained", cfg['net_name'] + '_' + cfg['data_name'] + "_deploy.pth"),
            })
