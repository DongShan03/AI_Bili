...
from YOLOv5.utils import utils
from YOLOv5.utils.loss import non_max_suppression
from YOLOv5.utils.datasets import letterbox
from YOLOv5.model.model import YOLOv5
from YOLOv5.utils.draw_box_utils import draw_objs
...
def predict(img_o, input_size, model, device, category_index, logging_info=True):
    ...
    pred = non_max_suppression(pred, conf_thres=0.1, iou_thres=0.6)[0]
