...
img_path_list = ["test1.jpg", "test2.jpg",]
...
def main():
    try:
        ...
        print(e)
        exit(-1)
    # net = Net(num_classes=num_classes, init_weights=False).to(device)
    ...
    with torch.no_grad():
        ...
        for idx, (prob, cla) in enumerate(zip(probs, classes)):
            print("num{} image: {}, class: {}, probability: {:.3f}" \
                    .format(idx+1, img_path_list[idx], class_indict[str(cla.cpu().numpy())], prob.item()))
