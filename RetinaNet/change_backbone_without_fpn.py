...
def create_model(num_classes):
    ...
    # # print(out["0"].shape)   #* 输出tensor格式 [batch_size=1, 512, H, W] 接下来的out_channels=512
    ...
    # # out = backbone(torch.rand((1, 3, 224, 224)))
    # # print(out["0"].shape)   #* 输出tensor格式 [batch_size=1, 1024, H, W] 接下来的out_channels=1024
    ...
    # out = backbone(torch.rand((1, 3, 224, 224)))
    # print(out["0"].shape)   #* 输出tensor格式 [batch_size=1, 112, H, W] 接下来的out_channels=112
