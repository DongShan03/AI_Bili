...
from YOLOv6.model.layers import *
...
class RepPANNeck(nn.Module):
    def __init__(self, channels_list=None, num_repeats=None, block=RepVGGBlock):
        ...
        self.Rep_p4 = RepBlock(
            in_channel=channels_list[3] + channels_list[5],
        ...
        self.Rep_p3 = RepBlock(
            in_channel=channels_list[2] + channels_list[6],
        ...
        self.Rep_n3 = RepBlock(
            in_channel=channels_list[6] + channels_list[7],
        ...
        self.Rep_n4 = RepBlock(
            in_channel=channels_list[5] + channels_list[9],
            out_channel=channels_list[10],
            n=num_repeats[8],
            block=block
        )
        ...
        self.downsample1 = ConvBNReLU(
            in_channel=channels_list[8],
            out_channel=channels_list[9],
            kernel_size=3,
            stride=2
        )
...
class RepPANNeck6(nn.Module):
    def __init__(self, channels_list=None, num_repeats=None, block=RepVGGBlock):
        ...
        self.Rep_p5 = RepBlock(
            in_channel=channels_list[4] + channels_list[6],
            out_channel=channels_list[6],
            n=num_repeats[6],
            block=block
        )
        ...
        self.upsample1 = Transpose(
            in_channel=channels_list[7],
            out_channel=channels_list[7],
        )

        self.Rep_p4 = RepBlock(
            in_channel=channels_list[3] + channels_list[7],
            out_channel=channels_list[7],
            n=num_repeats[7],
            block=block
        )
        ...
        self.Rep_p3 = RepBlock(
            in_channel=channels_list[2] + channels_list[8],
            out_channel=channels_list[8],
            n=num_repeats[8],
            block=block
        )
        ...
        self.Rep_n4 = RepBlock(
            in_channel=channels_list[8] + channels_list[8],
            out_channel=channels_list[9],
            n=num_repeats[9],
            block=block
        )
        ...
        self.Rep_n6 = RepBlock(
            in_channel=channels_list[6] + channels_list[10],
            out_channel=channels_list[11],
            n=num_repeats[11],
            block=block
        )
...
class CSPRepPANNeck(nn.Module):
    def __init__(self, channels_list=None, num_repeats=None, block=BottleRep,
                csp_e=float(1)/2, stage_block_type="BepC3"):
        super().__init__()
...
class CSPRepPANNeck_P6(nn.Module):
    ...
    def __init__(
        ...
        self.reduce_layer0 = ConvBNReLU(
            in_channel=channels_list[5], # 1024
            out_channel=channels_list[6], # 512
            kernel_size=1,
            stride=1
        )

        self.upsample0 = Transpose(
            in_channel=channels_list[6],  # 512
            out_channel=channels_list[6], # 512
        )

        self.Rep_p5 = stage_block(
            in_channel=channels_list[4] + channels_list[6], # 768 + 512
            out_channel=channels_list[6], # 512
            n=num_repeats[6],
            e=csp_e,
            block=block
        ...
        self.reduce_layer1 = ConvBNReLU(
            in_channel=channels_list[6],  # 512
            out_channel=channels_list[7], # 256
            kernel_size=1,
            stride=1
        )

        self.upsample1 = Transpose(
            in_channel=channels_list[7], # 256
            out_channel=channels_list[7] # 256
        )

        self.Rep_p4 = stage_block(
            in_channel=channels_list[3] + channels_list[7], # 512 + 256
            out_channel=channels_list[7], # 256
            n=num_repeats[7],
            e=csp_e,
            block=block
        ...
        self.reduce_layer2 = ConvBNReLU(
            in_channel=channels_list[7],  # 256
            out_channel=channels_list[8], # 128
            kernel_size=1,
            stride=1
        )

        self.upsample2 = Transpose(
            in_channel=channels_list[8], # 128
            out_channel=channels_list[8] # 128
        )

        self.Rep_p3 = stage_block(
            in_channel=channels_list[2] + channels_list[8], # 256 + 128
            out_channel=channels_list[8], # 128
            n=num_repeats[8],
            e=csp_e,
            block=block
        ...
        self.Rep_n4 = stage_block(
            in_channel=channels_list[8] + channels_list[8], # 128 + 128
            out_channel=channels_list[9], # 256
            n=num_repeats[9],
            e=csp_e,
            block=block
        )
        ...
        self.downsample1 = ConvBNReLU(
            in_channel=channels_list[9],  # 256
            out_channel=channels_list[9], # 256
            kernel_size=3,
            stride=2
        )
        ...
        self.Rep_n5 = stage_block(
            in_channel=channels_list[7] + channels_list[9], # 256 + 256
            out_channel=channels_list[10], # 512
            n=num_repeats[10],
            e=csp_e,
            block=block
        )
        ...
        self.downsample0 = ConvBNReLU(
            in_channel=channels_list[10],  # 512
            out_channel=channels_list[10], # 512
            kernel_size=3,
            stride=2
        )
        ...
        self.Rep_n6 = stage_block(
            in_channel=channels_list[6] + channels_list[10], # 512 + 512
            out_channel=channels_list[11], # 1024
            n=num_repeats[11],
            e=csp_e,
            block=block
        )
...
class Lite_EffiNeck(nn.Module):
    ...
    def forward(self, x):
        ...
        top_feature = self.p6_conv_1(fpn_out0)
        pan_out0 = top_feature + self.p6_conv_2(pan_out1)
